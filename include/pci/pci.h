...
#define PCI_HEADER_TYPE_MULTI_FUNCTIONAL_BIT (1 << 7)

enum pci_offset {
    PCI_OFFSET_VENDOR_ID = 0x00, // u16
    PCI_OFFSET_DEVICE_ID = 0x02, // u16

    PCI_OFFSET_COMMAND = 0x04, // u16
    PCI_OFFSET_STATUS = 0x06, // u16

    PCI_OFFSET_REVISION_ID = 0x08, // u8
    PCI_OFFSET_PROG_IF = 0x09, // u8
    PCI_OFFSET_SUBCLASS = 0x0A, // u8
    PCI_OFFSET_CLASS = 0x0B, // u8

    PCI_OFFSET_CACHE_LINE_SIZE = 0x0C, // u8
    PCI_OFFSET_LATENCY_TIMER = 0x0D, // u8
    PCI_OFFSET_HEADER_TYPE = 0x0E, // u8
    PCI_OFFSET_BIST = 0x0F, // u8
